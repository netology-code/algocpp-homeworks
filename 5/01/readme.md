...
Вам нужно реализовать функцию вывода целочисленной пирамиды, реализованной на массиве, на консоль. Функция будет называться `print_pyramid`.
